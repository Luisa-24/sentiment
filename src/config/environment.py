...
def setup_hf_token():
    ...
    if not hf_token:
        raise ValueError("HF_TOKEN environment variable is required. Get your token at https://huggingface.co/settings/tokens")
...
def setup_ffmpeg(script_dir: Path):
    ...
    """
    ffmpeg_path = script_dir / "engines" / "ffmpeg-2026-01-05-git-2892815c45-full_build" / "bin"
